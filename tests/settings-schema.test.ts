...
describe('settings schema', () => {
  ...
  it('drops the removed stage concurrency limit from legacy settings', () => {
    const legacy = { ...defaultSettings('/Users/test'), stageConcurrency: 1 }
    expect(AppSettingsSchema.parse(legacy)).not.toHaveProperty('stageConcurrency')
  })
